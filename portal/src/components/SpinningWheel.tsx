...
interface SpinningWheelProps {
  ...
  swipeTransition: { duration: number; [key: string]: unknown };
  clipStrLeft: string;
  clipStrRight: string;
  isMobile: boolean;
...
export default function SpinningWheel({ expandedSide, setExpandedSide, swipeTransition, clipStrLeft, clipStrRight, isMobile, centerNode, orbitRadius = 110 }: SpinningWheelProps) {
      ...
      <div className="absolute inset-0 w-full h-full z-50 pointer-events-none overflow-hidden">
        ...
        >
          <div className="absolute inset-0 w-full h-full">
            ...
            {/* The circular border */}
            <motion.div 
              className="absolute left-0 top-0 rounded-full border border-blue-400/30"
        ...
        >
          <div className="absolute inset-0 w-full h-full">
            ...
            >
            <motion.div 
              className="absolute left-0 top-0 rounded-full border border-teal-400/30"
              style={{ width: radius*2, height: radius*2, marginLeft: -radius, marginTop: -radius }}
              animate={{ opacity: expandedSide ? 0 : 1 }}
              transition={{ duration: 0.3 }}
            />
