...
export interface ApiAuthorAuthor extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Blog post authors and team members';
    displayName: 'Author';
    pluralName: 'authors';
    singularName: 'author';
  };
...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    isAnchor: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    isPinned: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::post.post'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    serviceType: Schema.Attribute.Enumeration<['construction', 'keyholding']> &
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A customer construction/renovation project';
    displayName: 'Project';
    pluralName: 'projects';
...
export interface ApiUpdateUpdate extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'An update or log entry for a specific project';
